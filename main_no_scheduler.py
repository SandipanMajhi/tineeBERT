...
if __name__ == "__main__":
    ...
    textloader, vocab = MaskedData.create_dataloader(corpus_path="BookCorpus/books.pkl", batch_size=64, mask_rate=0.15, max_tokens=256)
    bert_model = TineeBERT(num_repeats=10, vocab_size=len(vocab), embed_size=1024, seqlen=256, num_heads=16)
