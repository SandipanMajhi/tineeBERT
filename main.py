...
if __name__ == "__main__":
    ...
    warmup_steps = 10000
    textloader, unique_vocab = MaskedData.create_dataloader(corpus_path="BookCorpus/books.pkl", batch_size=256, mask_rate=0.15, max_tokens=512)
    bert_model = TineeBERT(num_repeats=10, vocab_size=len(unique_vocab), embed_size=768, seqlen=512, num_heads=16)
